  ...
  return userData && (
    <div className='max-w-lg mx-auto p-6 bg-white shadow-lg rounded-lg flex flex-col gap-6 text-sm text-gray-700'>
      ...
      <div className='mt-8 text-center'>
        {
          isEdit
            ? <button className='bg-blue-500 text-white px-6 py-2 rounded-full font-semibold hover:bg-blue-600 transition duration-200' onClick={updateUserProfileData}>Save Information</button>
